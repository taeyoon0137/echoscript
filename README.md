...
> Current recent version is `0.1.5`

| Package Name                                 | Descripton                      | Version |
| :------------------------------------------- | :------------------------------ | :-----: |
| [@echoscript/types](./packages/types)        | Type definition for Echoscript. | `0.1.5` |
| [@echoscript/core](./packages/core)          | Core logic of Echoscript.       | `0.1.5` |
| [@echoscript/yarn-plugin](./packages/plugin) | Run echoscript via yarn plugin. | `0.1.5` |
