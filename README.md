...
> Current recent version is `0.4.2`

| Package Name                               | Description                     | Version |
| :----------------------------------------- | :------------------------------ | :-----: |
| [@echoscript/types](packages/types)        | Type definition for Echoscript. | `0.4.2` |
| [@echoscript/core](packages/core)          | Core logic of Echoscript.       | `0.4.2` |
| [@echoscript/yarn-plugin](packages/plugin) | Run echoscript via yarn plugin. | `0.4.2` |
